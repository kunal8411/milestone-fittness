  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Choose from our variety of membership plans tailored to your fitness needs and goals."
        />
        ...
        <div className="bg-gray-900 text-white py-24">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl max-w-2xl mx-auto">
              Choose the perfect membership plan that aligns with your fitness
              goals and budget.
            </p>
          </div>
        </div>
            ...
            <div className="max-w-3xl mx-auto space-y-6">
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600">
                  Yes, you can freeze your membership for up to 30 days per year
                  with no additional cost. For longer periods, a small
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600">
                  There is a one-time joining fee of $25 for new members, which
                  covers your access card and initial fitness assessment.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-semibold mb-3 text-gray-600 ">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600">
                  Yes, we offer a 10% discount on additional family memberships
                  when two or more family members join together.
                </p>
              </div>
            </div>
          </div>
